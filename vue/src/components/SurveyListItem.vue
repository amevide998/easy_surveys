...
<template>
    <div class="flex flex-col py-6 px-4 shadow-md bg-white hover:bg-gray-50 h-[470px]"
    >
        ...
        <div class="flex justify-between mt-4 items-center">
            ...
            <div class="flex items-center">
                <a
                    ...
                    target="_blank"
                    class="h-8 w-8 flex items-center justify-center rounded-full border border-transparent text-indigo-500 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                >
